...
final class Update_Employee extends Add_Employee implements ActionListener{
    ...
    Update_Employee(String idaa){
        ...
        idd8.setFont(new Font("Arial",Font.ITALIC,40));
        ...
        idd1.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd1);
        ...
        idd2.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd2);
        ...
        idd3.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd3);
        ...
        idd4.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd4);
        ...
        idd5.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd5);
        ...
        idd6.setFont(new Font("Arial",Font.BOLD,20));    
        idd15.add(idd6);
        ...
        idd7.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd7);
        ...
        idd9.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd9);
        ...
        idd10.setFont(new Font("Arial",Font.BOLD,20));
        idd15.add(idd10);
